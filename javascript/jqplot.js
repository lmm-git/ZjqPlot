...
(function($) {
    ...
    function jqPlot() {
        ...
        this.parseOptions = function(options){
            ...
            if (jQuery.isPlainObject(opts.fillBetween)) {
        ...
        this.replot = function(options) {
            ...
            // otherwise, quickinit.
            if (data || !jQuery.isEmptyObject(opts)) {
        ...
        this.draw = function(){
            if (this.drawIfHidden || this.target.is(':visible')) {
                ...
                if (this.options.gridDimensions && jQuery.isPlainObject(this.options.gridDimensions)) {
        ...
        this.moveSeriesToFront = function (idx) { 
            idx = parseInt(idx, 10);
            var stackIndex = jQuery.inArray(idx, this.seriesStack);
   ...
   jQuery.jqplot.ColorGenerator = function(colors) {
    ...
    jQuery.jqplot.LineRenderer.prototype.initBands = function(options, plot) {
        ...
        else if (bd.length > 2 && !jQuery.isArray(bd[0][0])) {
    ...
    jQuery.jqplot.LinearAxisRenderer.prototype.init = function(options){
        ...
        jQuery.extend(true, this, options);
        if (this.breakPoints) {
            if (!jQuery.isArray(this.breakPoints)) {
                this.breakPoints = null;
            }
    ...
    jQuery.jqplot.LinearAxisRenderer.prototype.createTicks = function(plot) {
        ...
        if (userTicks.length) {
            ...
            for (i=0; i<userTicks.length; i++){
                ...
                else if (jQuery.isPlainObject(ut)) {
    ...
    jQuery.jqplot.LinearAxisRenderer.prototype.resetTickValues = function(opts) {
        if (jQuery.isArray(opts) && opts.length == this._ticks.length) {
            var t;
